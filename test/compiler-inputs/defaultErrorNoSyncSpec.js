...
function doMaxMunch(str, line, column) {
	let munch = Object.values(matchers).reduce(function match(acc, matcher) {
...
line: line
	...
	{
munch = Object.values(errors).reduce(function match(acc, error) {
...
publishToken(munch, tokens)
	...
	errors.push(`line ${munch.line}, column ${munch.column}: ${lookupError(munch.type)}`)
}
